...
:: RENOMBRA ORCHARD
REN C:\xampp\htdocs\REPORTES_FONARTE\*fullreport*.txt TMP_ORCHARD.txt;

:: RENOMBRA APPLEMUSIC
REN C:\xampp\htdocs\REPORTES_FONARTE\S1*.txt TMP_APPLEMUSIC.txt;

:: RENOMBRA ITUNES
REN C:\xampp\htdocs\REPORTES_FONARTE\*_ZZ*.txt TMP_ITUNES.txt;

:: RENOMBRA FINANCIAL_REPORT
REN C:\xampp\htdocs\REPORTES_FONARTE\financial*.txt TMP_FINANCIAL_REPORT.txt;

:: CARGA REPORTE APPLEMUSIC
bcp TMP_APPLEMUSIC in C:\xampp\htdocs\REPORTES_FONARTE\TMP_APPLEMUSIC.txt -S fonarte2.database.windows.net -d Reporteador -U Dataguys2 -P Fonarte2018 -q -c -t \t -r 0x0A -C 65001;

:: CARGA REPORTE ITUNES
bcp TMP_ITUNES in C:\xampp\htdocs\REPORTES_FONARTE\TMP_ITUNES.txt -S fonarte2.database.windows.net -d Reporteador -U Dataguys2 -P Fonarte2018 -q -c -t \t -r 0x0A -C 65001;

:: CARGA REPORTE DIVISAS
bcp TMP_FINANCIAL_REPORT in C:\xampp\htdocs\REPORTES_FONARTE\TMP_FINANCIAL_REPORT.txt -S fonarte2.database.windows.net -d Reporteador -U Dataguys2 -P Fonarte2018 -q -c -t \t -r 0x0A -C 65001;

:: CARGA REPORTE ORCHARD
bcp TMP_ORCHARD in C:\xampp\htdocs\REPORTES_FONARTE\TMP_ORCHARD.txt -S fonarte2.database.windows.net -d Reporteador -U Dataguys2 -P Fonarte2018 -q -c -t \t -r 0x0A -C 65001;
...
Robocopy C:\xampp\htdocs\REPORTES_FONARTE C:\xampp\htdocs\REPORTES_FONARTE_PROCESADOS /mov /s /w:1 /r:1